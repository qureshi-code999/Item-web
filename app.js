...
function SahilTraders() {
  ...
  }, /*#__PURE__*/React.createElement("span", null, "Ø§Ø±Ø¯Ùˆ")))), /*#__PURE__*/React.createElement("div", {
  ...
  })), /*#__PURE__*/React.createElement("span", null, language === 'ur' ? 'ÙˆØ§Ù¹Ø³ Ø§ÛŒÙ¾ Ù¾Ø± Ø±Ø§Ø¨Ø·Û Ú©Ø±ÛŒÚº' : 'WhatsApp (+92 336 8945775)')), /*#__PURE__*/React.createElement("div", {
    className: "text-center text-[10px] text-gray-500 space-y-0.5"
  }, /*#__PURE__*/React.createElement("p", {
    className: "font-semibold text-gray-700"
  }, language === 'ur' ? 'ÚˆÙ„ÛŒÙˆØ±ÛŒ Ú©Û’ Ø§ÙˆÙ‚Ø§Øª: ØµØ¨Ø­ 10:00 Ø¨Ø¬Û’ ØªØ§ Ø±Ø§Øª 8:00 Ø¨Ø¬Û’ (Ù¾ÛŒØ± ØªØ§ ÛÙØªÛ)' : 'Delivery Timing: 10:00 AM â€“ 8:00 PM (Mon â€“ Sat)'), /*#__PURE__*/React.createElement("p", null, language === 'ur' ? 'Ø³Ø§Ø­Ù„ Ø³Ù„ÛŒÙ… Ø§ÙˆØ± Ù…Ø­Ù…Ø¯ Ø²Ø¨ÛŒØ± Ù…Ø¹ÛŒÙ†' : 'Sahil Saleem & Muhammad Zubair Moin'))))), exitModalOpen && /*#__PURE__*/React.createElement("div", {
...
function OrderHistoryModal({
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, isUrdu ? 'Ø¢Ø±ÚˆØ± ÛØ³Ù¹Ø±ÛŒ' : 'Order History'), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 11,
      color: '#6b7280',
      marginTop: 2
    }
  }, isUrdu ? 'ØªÙ¾Ø´ Ú©Ø±ÛŒÚº Ø§ÙˆØ± Ù…Ú©Ù…Ù„ Ø¢Ø±ÚˆØ± Ø¯ÛŒÚ©Ú¾ÛŒÚº' : 'Tap an order card to view full items'))), /*#__PURE__*/React.createElement("button", {
    onClick: onClose,
    style: {
      width: 34,
      height: 34,
  ...
  }, isUrdu ? 'Ø§Ø¨Ú¾ÛŒ Ú©ÙˆØ¦ÛŒ Ø¢Ø±ÚˆØ± Ù…Ø­ÙÙˆØ¸ Ù†ÛÛŒÚº' : 'No saved orders yet'), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 12,
      color: '#6b7280',
      marginTop: 6
    }
  }, isUrdu ? 'Ø¢Ù¾ Ú©Ø§ Ø§Ú¯Ù„Ø§ Ø¢Ø±ÚˆØ± ÛŒÛØ§Úº Ù†Ø¸Ø± Ø¢Ø¦Û’ Ú¯Ø§' : 'Your placed orders will appear here automatically.')) : /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      flexDirection: 'column',
      gap: 12
    ...
    }, order.deliveryMethod === 'pickup' ? isUrdu ? 'Ø§Ø³Ù¹ÙˆØ± Ù¾Ú© Ø§Ù¾' : 'Store Pickup' : isUrdu ? 'ÛÙˆÙ… ÚˆÙ„ÛŒÙˆØ±ÛŒ' : 'Home Delivery')), /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 11,
        color: '#6b7280',
        marginTop: 3,
    ...
    }, isExpanded ? isUrdu ? 'Ø¨Ù†Ø¯ Ú©Ø±ÛŒÚº â–²' : 'Collapse â–²' : isUrdu ? 'ØªÙØµÛŒÙ„ Ø¯ÛŒÚ©Ú¾ÛŒÚº â–¼' : 'View Details â–¼')))), isExpanded && /*#__PURE__*/React.createElement("div", {
      style: {
    ...
    }, isUrdu ? 'Ø§Ø´ÛŒØ§Ø¡ Ú©ÛŒ ÙÛØ±Ø³Øª:' : 'Itemized Receipt:'), order.items.map(item => /*#__PURE__*/React.createElement("div", {
  ...
  }, isUrdu ? 'ÛØ³Ù¹Ø±ÛŒ ØµØ§Ù Ú©Ø±ÛŒÚº' : 'Clear History'))));
}
function CheckoutModal({
  ...
  function handleOrder() {
    ...
    // Build WhatsApp message with rich UTF-8 emojis
