...
// =============================================================
//  ✅ MASTER SOURCE FILE — ZS Mart WEBSITE
//  Filename : INDEX.JSX
...
function saveInvoiceAsImage(order, language) {
  ...
  ctx.fillText(order.deliveryMethod === 'pickup' ? '🏬 Store Pickup (ZS Mart Karachi)' : '🚚 Home Delivery', width / 2 + 10, 158);
  ctx.fillStyle = '#64748b';
  ctx.font = '500 10.5px system-ui, sans-serif';
  const addr = order.customer?.address || (order.deliveryMethod === 'pickup' ? 'ZS Mart Karachi Store' : '');
  ...
  ctx.fillText('❤️ Thank you for choosing ZS Mart!', width / 2, curY);
  curY += 18;
  ctx.fillStyle = '#64748b';
  ctx.font = '500 10.5px system-ui, sans-serif';
...
function generatePDFReceipt(order, language) {
  ...
  const printHtml = `
        ...
        <head>
          ...
          <title>Invoice #${order.id} - ZS Mart</title>
          <style>
        ...
        <body>
          <div class="invoice-card">
            <div class="header">
              <div>
                <h1 class="brand-title">ZS Mart</h1>
            ...
            <div class="meta-grid">
              ...
              <div>
                ...
                <div class="meta-val">${order.deliveryMethod === 'pickup' ? '🏬 Store Pickup (ZS Mart Karachi)' : '🚚 Home Delivery'}</div>
                <div style="color: #64748b; font-size: 11px;">${order.customer?.address || 'ZS Mart Karachi Store'}</div>
              </div>
            </div>
            ...
            <div class="footer">
              <div>❤️ <strong>Thank you for choosing ZS Mart!</strong></div>
          ...
          <script>
            ...
            window.saveToGallery = async function() {
              ...
              try {
                ...
                ctx.fillStyle = '#0f172a';
                ctx.font = '800 12.5px system-ui, sans-serif';
                ctx.fillText(orderData.deliveryMethod === 'pickup' ? '🏬 Store Pickup (ZS Mart Karachi)' : '🚚 Home Delivery', width / 2 + 10, 158);
                ctx.fillStyle = '#64748b';
                ctx.font = '500 10.5px system-ui, sans-serif';
                const addr = orderData.customer?.address || (orderData.deliveryMethod === 'pickup' ? 'ZS Mart Karachi Store' : '');
                ctx.fillText(addr.length > 32 ? addr.substring(0, 32) + '...' : addr, width / 2 + 10, 174);
                ...
                canvas.toBlob(async function(blob) {
                  ...
                  if (navigator.canShare && navigator.canShare({ files: [file] })) {
                    try {
                      await navigator.share({
                        files: [file],
                        title: 'ZS Mart Invoice #' + (orderData.id || ''),
...
var PRODUCTS = [{
  ...
  price: 180,
  categoryId: "sports",
  categoryName: "Sports & Toys & Birthday"
}, {
  id: 15,
  ...
  categoryName: "Fragnances & Roll on",
  hasImage: true,
  gradient: SWATCH_GRADIENTS[0],
  initial: "B"
}, {
  ...
  price: 50,
  categoryId: "lock",
  categoryName: "Locks & Cells & Lighters"
}, {
  id: 156,
  ...
  price: 190,
  categoryId: "facewash",
  categoryName: "Face Wash & Body Washes",
  hasImage: true,
  gradient: SWATCH_GRADIENTS[6],
  initial: "F"
}, {
  ...
  price: 0,
  categoryId: "babycare",
  categoryName: "Baby Care & Powders"
}, {
  id: 503,
  ...
  id: 1269,
  name: "LEMON MAX LONG BAR RS,100",
  price: 95,
  categoryId: "general",
  categoryName: "General Items & Others",
  hasImage: true,
  ...
  id: 1270,
  name: "LEMON MAX BAR SMALL RS,35",
  price: 34,
  categoryId: "general",
  categoryName: "General Items & Others",
  hasImage: true,
...
function AboutUsModal({
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "ZS Mart"), /*#__PURE__*/React.createElement("p", {
  ...
  }, tr(modalLang, 'Established in 2021 in Karachi, ZS Mart brings direct wholesale prices to customers on 4,000+ daily essentials and branded products, even if you are buying just 1 item.', 'ZS Mart ka aaghaz 2021 mein Karachi se wholesale business ke tor par hua. Hamara maqsad har customer ko 4,000+ products direct wholesale rates par faraham karna hai, chahe aap 1 item hi kyun na le rahe hon.', 'ZS مارٹ کا آغاز 2021 میں کراچی سے ہول سیل بزنس کے طور پر ہوا۔ ہمارا مقصد تمام گاہکوں کو 4,000+ مصنوعات براہِ راست ہول سیل ریٹس پر فراہم کرنا ہے، چاہے وہ 1 آئٹم ہی کیوں نہ خرید رہے ہوں۔'))), /*#__PURE__*/React.createElement("div", {
  ...
  }, tr(modalLang, 'Owner — ZS Mart', 'Owner — ZS Mart', 'آنر ZS Mart')))), /*#__PURE__*/React.createElement("div", {
    className: "bg-white/10 border border-white/10 rounded-xl p-3 flex items-center gap-2.5"
  }, /*#__PURE__*/React.createElement("div", {
  ...
  }, tr(modalLang, '💡 This complete business setup is jointly managed by both brothers, Muhammad Zubair Moin (Owner, ZS Mart) & Muhammad Sahil Saleem.', '💡 Ye pura business setup dono bhai Muhammad Zubair Moin (Owner, ZS Mart) aur Muhammad Sahil Saleem mil kar chala rahe hain.', '💡 یہ تمام تر سیٹ اپ اور بزنس محمد زبیر معین (مالک ZS Mart) اور محمد ساحل سلیم دونوں بھائی مل کر مشترکہ طور پر چلا رہے ہیں۔'))), /*#__PURE__*/React.createElement("div", {
    ...
    className: "text-lg"
  }, "\uD83C\uDFEC"), /*#__PURE__*/React.createElement("span", null, tr(modalLang, 'Visit Our Physical Shop (ZS Mart)', 'Hamari Dukan par Tashreef Layein (ZS Mart)', 'ہماری فزیکل دکان (ZS Mart)'))), /*#__PURE__*/React.createElement("span", {
    className: "bg-emerald-600 text-white text-[10px] font-black px-2 py-0.5 rounded-full uppercase tracking-wider"
  }, tr(modalLang, 'ZS Mart', 'ZS Mart', 'ZS مارٹ'))), /*#__PURE__*/React.createElement("p", {
  ...
  }, tr(modalLang, 'Visit our physical shop ZS Mart! Almost all items listed on this website are available in person at our store. (Note: Due to high demand or market shortage, certain items may temporarily be out of stock, but we restock continuously!)', 'Aap hamari physical dukan ZS Mart par bhi aa sakte hain! Website ki taqreeban tamam cheezein dukan par dastyab hain. (Note: Market shortage ki wajah se kuch cheezein temporary out of stock ho sakti hain, lekin hum daily restock karte hain!)', 'ہے۔ ویب سائٹ پر موجود تقریباً تمام تر مصنوعات آپ کو ہماری دکان (ZS Mart) پر بھی مل جائیں گی۔ (نوٹ: شارٹیج یا زیادہ ڈیمانڈ کی صورت میں شاید کچھ پروڈکٹس عارضی طور پر دکان پر اسٹاک میں نہ ہوں، لیکن ہم مسلسل ری اسٹاک کرتے ہیں!)'))), /*#__PURE__*/React.createElement("div", {
    ...
    className: "font-bold text-gray-900"
  }, "ZS Mart (Wholesale & Retail)"), /*#__PURE__*/React.createElement("div", {
    ...
    title: "ZS Mart Google Map Location",
...
function ReturnPolicyModal({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "text-[11px] text-gray-600 leading-relaxed font-medium"
  }, tr(language, 'You can also visit ZS Mart (Korangi, Karachi) for immediate in-person exchange.', 'Hamari physical shop ZS Mart (Korangi, Karachi) aakar bhi fori tabdeel karwa sakte hain.', 'ہماری فزیکل شاپ ZS Mart (کورنگی، کراچی) آکر بھی تبدیل کروا سکتے ہیں'))), /*#__PURE__*/React.createElement("div", {
    className: "bg-gray-50 border border-gray-200 rounded-2xl p-3.5 space-y-1"
  }, /*#__PURE__*/React.createElement("div", {
    className: "flex items-center gap-2 font-black text-gray-900"
  }, /*#__PURE__*/React.createElement("svg", {
...
function WelcomeDisclaimerModal({
  ...
  }, tr(modalLang, 'Welcome to ZS Mart', 'ZS Mart mein Khush Amdeed', 'ZS مارٹ میں خوش آمدید')), /*#__PURE__*/React.createElement("div", {
...
function ParchiOrderModal({
  ...
  const handleSubmit = async e => {
    ...
    if (photoFile && navigator.canShare && navigator.canShare({
      ...
      try {
        await navigator.share({
          files: [photoFile],
          title: `ZS Mart Parchi Order #${orderId}`,
          text: waText
        });
        sharedWithFile = true;
      } catch (err) {
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, tr(language, 'Parchi / Photo Order', 'Parchi / Photo Order', 'پرچی / فوٹو آرڈر')), /*#__PURE__*/React.createElement("p", {
    className: "text-[10px] text-emerald-100 font-medium"
  }, tr(language, 'Upload written slip & order in 5 seconds', 'Haath se likhi list upload karein aur 5 sec mein order bhein', 'ہاتھ سے لکھی پرچی بھیجیں')))), /*#__PURE__*/React.createElement("button", {
    type: "button",
    onClick: onClose,
    ...
    className: "absolute top-2 right-2 bg-red-600 hover:bg-red-700 text-white px-2.5 py-1 rounded-lg text-xs font-bold shadow-md cursor-pointer transition-colors flex items-center gap-1"
  }, /*#__PURE__*/React.createElement("span", null, "\uD83D\uDDD1\uFE0F"), /*#__PURE__*/React.createElement("span", null, tr(language, 'Remove / Retake', 'Dobara Lein', 'دوبارہ لیں')))) : /*#__PURE__*/React.createElement("div", {
    className: "grid grid-cols-2 gap-2.5"
  }, /*#__PURE__*/React.createElement("label", {
    className: "border-2 border-dashed border-emerald-400 hover:border-emerald-600 bg-emerald-50/40 hover:bg-emerald-50/70 rounded-2xl p-4 flex flex-col items-center justify-center text-center cursor-pointer transition-all active:scale-95 shadow-2xs group"
    ...
    className: "w-11 h-11 rounded-2xl bg-emerald-600 text-white flex items-center justify-center text-xl mb-2 shadow-sm group-hover:scale-110 transition-transform"
  }, "\uD83D\uDCF7"), /*#__PURE__*/React.createElement("span", {
    className: "text-xs font-black text-gray-900 leading-tight"
  }, tr(language, 'Take Photo', 'Camera Se Khainchein', 'کیمرہ سے تصویر لیں')), /*#__PURE__*/React.createElement("span", {
    className: "text-[10px] text-emerald-800 font-semibold mt-1"
  }, tr(language, 'Open Camera', 'Live Camera', 'لائیو کیمرہ'))), /*#__PURE__*/React.createElement("label", {
    className: "border-2 border-dashed border-teal-400 hover:border-teal-600 bg-teal-50/40 hover:bg-teal-50/70 rounded-2xl p-4 flex flex-col items-center justify-center text-center cursor-pointer transition-all active:scale-95 shadow-2xs group"
  }, /*#__PURE__*/React.createElement("input", {
    type: "file",
    accept: "image/*",
    onChange: handlePhotoUpload,
    ...
    className: "w-11 h-11 rounded-2xl bg-teal-600 text-white flex items-center justify-center text-xl mb-2 shadow-sm group-hover:scale-110 transition-transform"
  }, "\uD83D\uDDBC\uFE0F"), /*#__PURE__*/React.createElement("span", {
    className: "text-xs font-black text-gray-900 leading-tight"
  }, tr(language, 'Upload Gallery', 'Gallery Se Chunin', 'گیلری سے منتخب کریں')), /*#__PURE__*/React.createElement("span", {
    className: "text-[10px] text-teal-800 font-semibold mt-1"
  }, tr(language, 'Phone Photos', 'Mobile Gallery', 'موبائل گیلری'))))), /*#__PURE__*/React.createElement("div", {
    className: "grid grid-cols-1 sm:grid-cols-2 gap-2.5"
  }, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("label", {
    className: "block text-[11px] font-bold text-gray-700 mb-1"
  }, tr(language, 'Your Name *', 'Apka Naam *', 'آپ کا نام *')), /*#__PURE__*/React.createElement("input", {
    type: "text",
    required: true,
    value: name,
    ...
    className: "block text-[11px] font-bold text-gray-700 mb-1"
  }, tr(language, 'WhatsApp Phone *', 'WhatsApp Number *', 'واٹس ایپ نمبر *')), /*#__PURE__*/React.createElement("input", {
    type: "tel",
    required: true,
    value: phone,
    ...
    className: `p-2 rounded-xl border text-xs font-bold flex items-center justify-center gap-1.5 transition-all cursor-pointer ${deliveryMethod === 'home' ? 'border-emerald-600 bg-emerald-50 text-emerald-800' : 'border-gray-200 bg-white text-gray-600'}`
  }, /*#__PURE__*/React.createElement("span", null, "\uD83D\uDE9A"), /*#__PURE__*/React.createElement("span", null, tr(language, 'Home Delivery', 'Home Delivery', 'ہوم ڈلیوری'))), /*#__PURE__*/React.createElement("button", {
    type: "button",
    ...
    placeholder: "e.g. Bhai 2 peti Lux aur 1 carton Surf bhej dena...",
...
function WishlistDrawer({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "p-4 border-b border-gray-100 flex items-center justify-between bg-white"
  }, /*#__PURE__*/React.createElement("div", {
    className: "flex items-center gap-2"
  }, /*#__PURE__*/React.createElement("span", {
    className: "text-xl text-rose-600"
  }, "\u2764\uFE0F"), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("h3", {
    className: "font-extrabold text-base text-gray-900 leading-tight"
  }, tr(language, 'My Wishlist (Favorites)', 'Meri Pasandeeda Ashya', 'میری پسندیدہ اشیاء')), /*#__PURE__*/React.createElement("p", {
    className: "text-[11px] text-gray-500"
  }, wishlistedProducts.length, " ", tr(language, 'saved items', 'items save hain', 'اشیاء محفوظ ہیں')))), /*#__PURE__*/React.createElement("button", {
    type: "button",
    onClick: onClose,
  ...
  }, wishlistedProducts.length === 0 ? /*#__PURE__*/React.createElement("div", {
    className: "text-center py-16 space-y-3"
  }, /*#__PURE__*/React.createElement("div", {
    className: "w-16 h-16 rounded-full bg-rose-50 text-rose-500 flex items-center justify-center text-3xl mx-auto"
  }, "\uD83E\uDD0D"), /*#__PURE__*/React.createElement("h4", {
    className: "font-black text-gray-900 text-base"
  }, tr(language, 'Your wishlist is empty', 'Wishlist abhi khali hai', 'آپ کی وش لسٹ خالی ہے')), /*#__PURE__*/React.createElement("p", {
    className: "text-xs text-gray-500 max-w-xs mx-auto"
  }, tr(language, 'Tap the heart icon on any product to save it here for quick repeat orders.', 'Kisi bhi product par dil (heart) daba kar save karein.', 'پروڈکٹ پر دل کے نشان کو دبا کر محفوظ کریں۔'))) : wishlistedProducts.map(product => {
    const pricing = getProductPricing(product);
    const hasFile = window.PRODUCT_IMAGE_MAP && window.PRODUCT_IMAGE_MAP[product.id];
    const imgSrc = hasFile ? getImgUrl(`images/${product.id}.${window.PRODUCT_IMAGE_MAP[product.id]}`) : null;
    return /*#__PURE__*/React.createElement("div", {
      key: product.id,
      className: "flex items-center gap-3 p-2.5 rounded-2xl border border-gray-100 hover:border-gray-300 bg-white transition-all shadow-2xs"
    }, /*#__PURE__*/React.createElement("div", {
      className: "w-14 h-14 bg-gray-50 rounded-xl p-1 flex items-center justify-center shrink-0"
    }, hasFile ? /*#__PURE__*/React.createElement("img", {
      src: imgSrc,
      alt: product.name,
      className: "w-full h-full object-contain"
    }) : /*#__PURE__*/React.createElement("div", {
      className: "w-10 h-10 rounded-lg bg-gray-200 flex items-center justify-center font-bold text-gray-700 text-sm"
      ...
      className: "font-black text-xs text-gray-950"
    }, "Rs. ", pricing.sellingPrice.toLocaleString()), pricing.hasDiscount && /*#__PURE__*/React.createElement("span", {
      ...
      className: "px-2.5 py-1.5 bg-gray-900 hover:bg-black text-white text-xs font-bold rounded-lg cursor-pointer transition-colors shadow-2xs"
    }, "+ Cart"), /*#__PURE__*/React.createElement("button", {
      type: "button",
      onClick: () => {
        triggerHaptic('light');
        if (onRemoveWishlist) onRemoveWishlist(product);
      },
      className: "p-1.5 text-gray-400 hover:text-red-500 rounded-lg cursor-pointer transition-colors",
      title: "Remove"
    }, "\u2715")));
  })), wishlistedProducts.length > 0 && /*#__PURE__*/React.createElement("div", {
    className: "p-4 border-t border-gray-100 bg-gray-50 space-y-2"
  }, /*#__PURE__*/React.createElement("button", {
    type: "button",
    onClick: handleAddAll,
    className: "w-full py-3 bg-rose-600 hover:bg-rose-700 text-white font-extrabold text-xs rounded-xl uppercase tracking-wider flex items-center justify-center gap-2 shadow-md shadow-rose-600/20 active:scale-95 transition-all cursor-pointer"
  }, /*#__PURE__*/React.createElement("span", null, "\uD83D\uDED2"), /*#__PURE__*/React.createElement("span", null, tr(language, 'Add All to Cart', 'Saari Ashya Cart Mein Daalein', 'تمام اشیاء کارٹ میں شامل کریں'), " (", wishlistedProducts.length, ")")))));
}
function ProductDetailModal({
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, tr(language, 'Wholesale Rate', 'Behtareen Wholesale Rate', 'بہترین ہول سیل ریٹ'))), /*#__PURE__*/React.createElement("div", {
    className: "flex items-center gap-2"
  }, /*#__PURE__*/React.createElement("button", {
    type: "button",
    onClick: () => onToggleWishlist && onToggleWishlist(product),
    className: `w-8 h-8 rounded-full flex items-center justify-center transition-all cursor-pointer ${isWishlisted ? 'bg-rose-50 border border-rose-200 text-rose-600 scale-105 shadow-2xs' : 'bg-white border border-gray-200 text-gray-400 hover:text-rose-500 hover:border-rose-200'}`,
    ...
    }, "\uD83C\uDFF7\uFE0F Item Discount (", pricing.discountPercent, "% OFF \xD7 ", modalQty, ")"), /*#__PURE__*/React.createElement("span", {
      style: {
        fontSize: 10,
        fontWeight: 900,
        color: '#065f46',
    ...
    className: "text-[10px] text-gray-500"
  }, tr(language, 'ZS Mart Shop Karachi', 'ZS Mart Dukan Karachi', 'ZS Mart دکان سے لیں'))))), relatedProducts.length > 0 && /*#__PURE__*/React.createElement("div", {
...
const SORT_OPTIONS = [{
  id: 'default',
  label: 'Default Order',
  labelUrdu: 'عام ترتیب (Default)',
  icon: '⚡'
}, {
  id: 'price_asc',
  label: 'Price: Low to High',
  labelUrdu: 'قیمت: کم سے زیادہ (Low to High)',
  icon: '📈'
}, {
  id: 'price_desc',
  label: 'Price: High to Low',
  labelUrdu: 'قیمت: زیادہ سے کم (High to Low)',
  icon: '📉'
}, {
  id: 'popularity',
  label: 'Popularity / Featured',
  labelUrdu: 'مقبول ترین (Featured)',
  icon: '⭐'
}, {
  id: 'name_asc',
  label: 'Name: A to Z',
...
function SahilTraders() {
  ...
  useEffect(() => {
    window.handleAppBackButton = () => {
      ...
      // 2. If Sort Modal or Filter Menu is open, close it
      if (sortModalOpen) {
      ...
      // 3. If Product Details modal is open, close it
      if (selectedProduct) {
  ...
  function handleVoiceSearch() {
    ...
    // Fallback for Android WebView where SpeechRecognition is not bundled:
    if (searchInputRef.current) {
      searchInputRef.current.focus();
      setSuggestOpen(true);
    }
    alert(tr(language, '🎙️ Voice Search Active! Please speak using the Microphone 🎤 on your keyboard.', '🎙️ Voice Search: Apne mobile keyboard ke Mic 🎤 button se bol kar search karein.', '🎙️ وائس سرچ: موبائل کی بورڈ کے مائیک 🎤 سے بول کر سرچ کریں۔'));
  }
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "flex sm:hidden items-center justify-between gap-2 relative w-full h-[40px]"
  }, /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      ...
      transform: mobileSearchFocused || searchTerm ? 'scale3d(1,1,1) translate3d(0,0,0)' : 'scale3d(0.95,0.88,1) translate3d(0,-6px,0)',
  ...
  }, "ZS Mart Customer"), /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: '9px',
      fontWeight: 800,
      background: '#dcfce7',
  ...
  }, tr(language, 'About ZS Mart', 'ZS Mart ke Baare Mein', 'ZS Mart کے بارے میں')), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: '10px',
      color: '#64748b',
      marginTop: '1px'
  ...
  }, "ZS Mart, Karachi, Sindh, Pakistan")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      alignItems: 'center',
      gap: '8px',
  ...
  }, "ZS Mart Official App v9.6"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: '9.5px',
      color: '#94a3b8',
      marginTop: '2px'
    ...
    onToggleWishlist: toggleWishlist
  }), /*#__PURE__*/React.createElement(ParchiOrderModal, {
    open: parchiModalOpen,
    onClose: () => setParchiModalOpen(false),
    language: language,
    saveOrderHistory: saveOrderHistory
  }), /*#__PURE__*/React.createElement(WishlistDrawer, {
    open: wishlistOpen,
    ...
    className: "w-full flex items-center justify-between p-3.5 rounded-2xl bg-gradient-to-r from-emerald-600 to-teal-700 text-white transition-all text-left cursor-pointer shadow-md shadow-emerald-600/20 active:scale-95"
  }, /*#__PURE__*/React.createElement("div", {
    className: "flex items-center gap-3"
  }, /*#__PURE__*/React.createElement("div", {
  ...
  }, tr(language, 'Upload slip, order in 5 seconds!', 'Slip upload karein, 5 sec mein order!', 'پرچی اپلوڈ کریں، 5 سیکنڈ میں آرڈر!')))), /*#__PURE__*/React.createElement("span", {
    ...
    className: "w-full flex items-center justify-between p-3.5 rounded-2xl bg-white border border-rose-200 hover:bg-rose-50 transition-all text-left cursor-pointer shadow-2xs"
  }, /*#__PURE__*/React.createElement("div", {
    className: "flex items-center gap-3"
  }, /*#__PURE__*/React.createElement("div", {
    className: "w-10 h-10 rounded-xl bg-rose-50 border border-rose-100 flex items-center justify-center text-xl"
  }, "\u2764\uFE0F"), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("p", {
    className: "text-xs font-bold text-gray-900"
  }, tr(language, 'My Wishlist (Favorites)', 'Meri Pasandeeda Ashya', 'میری پسندیدہ اشیاء')), /*#__PURE__*/React.createElement("p", {
    className: "text-[11px] text-gray-500"
  }, tr(language, 'Save items & order monthly groceries', 'Monthly saman save karein', 'ماہانہ سامان محفوظ کریں')))), wishlist.length > 0 ? /*#__PURE__*/React.createElement("span", {
    className: "px-2 py-0.5 rounded-full text-[10px] font-black bg-rose-600 text-white"
  }, wishlist.length) : /*#__PURE__*/React.createElement("span", {
    className: "text-gray-400 text-xs"
  }, "\u203A")), /*#__PURE__*/React.createElement("button", {
    onClick: () => {
      setMobileMenuOpen(false);
  ...
  }, tr(language, 'Exit ZS Mart?', 'ZS Mart se Bahar Jana Chahte Hain?', 'ویب سائٹ سے باہر جانا چاہتے ہیں؟')), /*#__PURE__*/React.createElement("p", {
    className: "text-xs text-gray-700 mt-1.5 leading-relaxed"
  }, tr(language, 'Are you sure you want to leave the store?', 'Kya aap ZS Mart band karna chahte hain?', 'کیا آپ واقعی ZS Mart بند کرنا چاہتے ہیں؟'))), /*#__PURE__*/React.createElement("div", {
  ...
  }, tr(language, 'Yes, Exit', 'Haan, Bahar Jaein', 'ہاں، باہر جائیں'))))), /*#__PURE__*/React.createElement("nav", {
    className: "sm:hidden",
    style: {
      position: 'fixed',
      bottom: 0,
    ...
    style: {
      width: 20,
      height: 20,
      color: activeTab === 'home' ? '#059669' : '#0f172a'
    },
  ...
  }, tr(language, 'Orders', 'Orders', 'آرڈرز'))), /*#__PURE__*/React.createElement("button", {
    onClick: () => {
      triggerHaptic('medium');
      setCartOpen(true);
    },
    ...
    style: {
      ...
      boxShadow: '0 6px 18px rgba(16,185,129,0.5), 0 0 0 3.5px rgba(255,255,255,0.9)',
      display: 'flex',
      alignItems: 'center',
      justifyContent: 'center',
      position: 'relative',
  ...
  }, cartCount > 9 ? '9+' : cartCount)), /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: '10px',
      fontWeight: 800,
      color: '#0f172a',
  ...
  }, tr(language, 'Cart', 'Cart', 'کارٹ'))), /*#__PURE__*/React.createElement("button", {
    onClick: () => {
      triggerHaptic('medium');
      setParchiModalOpen(true);
    },
...
function CartDrawer({
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
  ...
  }, /*#__PURE__*/React.createElement("span", null, "\uD83C\uDFE0 ", tr(language, 'Home Delivery Available', 'Home Delivery Dastyab Hai', 'ہوم ڈیلیوری دستیاب')), /*#__PURE__*/React.createElement("span", null, "\uD83C\uDFEC ", tr(language, 'ZS Mart Pickup Free', 'ZS Mart Pickup Muft', 'ZS Mart پک اپ مفت')))), cart.length === 0 ? /*#__PURE__*/React.createElement("div", {
    style: {
      textAlign: 'center',
      paddingTop: 80,
      color: '#777777'
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      amount: product.price.toLocaleString()
    }), " \xD7 ", qty), pricing.hasDiscount && /*#__PURE__*/React.createElement("span", {
      style: {
        fontSize: 10,
        color: '#9ca3af',
...
function CheckoutModal({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    }, "\xD7 ", qty, " = ", translate(langData, "priceLabel", {
      amount: bulk.finalTotal.toLocaleString()
    })));
  })), /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }, "ZS Mart (FREE)")))), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      flexDirection: 'column',
      gap: 14
  ...
  }, "\u0622\u067E \u06A9\u0627 \u0622\u0631\u0688\u0631 \u062A\u06CC\u0627\u0631 \u06C1\u0648\u0646\u06D2 \u0645\u06CC\u06BA 20 \u0645\u0646\u0679 \u0633\u06D2 1 \u06AF\u06BE\u0646\u0679\u06C1 \u0644\u06AF \u0633\u06A9\u062A\u0627 \u06C1\u06D2\u06D4 \u0627\u0633 \u0648\u0642\u062A \u06A9\u06D2 \u0628\u0639\u062F \u0622\u067E ZS Mart \u0627\u0633\u0679\u0648\u0631 (\u0645\u062D\u0645\u062F \u0632\u0628\u06CC\u0631 \u0645\u0639\u06CC\u0646 / \u0645\u062D\u0645\u062F \u0633\u06C1\u06CC\u0644 \u0633\u0644\u06CC\u0645) \u0633\u06D2 \u0627\u067E\u0646\u0627 \u0633\u0627\u0645\u0627\u0646 \u067E\u06A9 \u0627\u067E \u06A9\u0631 \u0633\u06A9\u062A\u06D2 \u06C1\u06CC\u06BA\u06D4"))), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      alignItems: 'flex-start',
      gap: 10,
